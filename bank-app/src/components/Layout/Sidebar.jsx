    ...
    <aside className="sidebar">
      <div className="sidebar-logo">
        ...
        <div className="logo-text">
          <span className="logo-title">KB Bank</span>
      ...
      <nav className="sidebar-nav">
        <div className="nav-section">
          <span className="nav-section-title">메인</span>
        ...
        <div className="nav-section">
          <span className="nav-section-title">관리</span>
        ...
        <div className="nav-section">
          <span className="nav-section-title">시스템</span>
